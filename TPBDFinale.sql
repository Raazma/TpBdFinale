...
DROP TABLE FicheMatch CASCADE CONSTRAINTS;
...
CREATE TABLE FicheMatch
  (
    NumMatch           NUMBER (4) NOT NULL ,
    ScoreFinaleEquipeV NUMBER (2) ,
    ScoreFinaleEquipeR NUMBER (2)
  ) ;
...
ALTER TABLE FicheMatch ADD CONSTRAINT FicheMatch_Match_FK FOREIGN KEY ( NumMatch ) REFERENCES MATCH ( NumMatch ) ;
...
INSERT INTO EQUIPE (NUMDIVISION,DATEINTROPDUCTION,LOGO,VILLE,NOMEQUIPE)
VALUE(3,'04-AUG-2003',
